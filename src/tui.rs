...
// Const for layout
lazy_static! {
    pub static ref CONTEXT_INFORMATION_LENGHT: u16 = 6;
    pub static ref INPUT_LENGTH: u16 = 3;
    pub static ref INPUTS_MODES: Vec<Mode> = vec![Mode::Search, Mode::Command];
    pub static ref BREADCRUMB_LENGHT: u16 = 1;
}
...
impl Tui {
    ...
    pub fn generate_main_constraint(&self, mode: Mode) -> Vec<Constraint> {
        ...
        vec![
            Constraint::Length(*CONTEXT_INFORMATION_LENGHT),
            input_length,
            Constraint::Fill(1),
            Constraint::Length(*BREADCRUMB_LENGHT),
        ]
    }
    ...
    pub fn generate_main_chunks(&mut self, hash: &mut HashMap<Chunk, Rc<[Rect]>>, mode: Mode) {
        hash.insert(
            ...
            Layout::default()
                ...
                .constraints(self.generate_main_constraint(mode))
                .margin(1)
